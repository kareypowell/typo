Feature: Merge Articles
  ...
  Background: articles and users have been added to database
    ...
    Given the following articles exist:
      ...
      | 3  | Article1 | user_1 | 2       | Content1 | true           | true      | 2013-23-08 21:30:00 | published | Article |
      | 4  | Article2 | user_2 | 3       | Content2 | true           | true      | 2013-24-08 22:00:00 | published | Article |

    Given the following comments exist:
      | id | type    | author | body     | article_id | user_id | created_at          |
      | 1  | Comment | user_1 | Comment1 | 3          | 2       | 2013-23-08 21:31:00 |
      | 2  | Comment | user_1 | Comment2 | 4          | 2       | 2013-24-08 22:01:00 |
